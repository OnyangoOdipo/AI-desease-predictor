...
# Load datasets
try:
    sym_des = pd.read_csv(r"bot/datasets/description.csv")
    precautions = pd.read_csv(r"bot/datasets/precautions_df.csv")
    workout = pd.read_csv(r"bot/datasets/workout_df.csv")
    description = pd.read_csv(r"bot/datasets/description.csv")
    medications = pd.read_csv(r'bot/datasets/medications.csv')
    diets = pd.read_csv(r"bot/datasets/diets.csv")
except Exception as e:
    print(f"Error loading datasets: {e}")

# Load model
try:
    svc = pickle.load(open(r'bot/svc.pkl','rb'))
except Exception as e:
